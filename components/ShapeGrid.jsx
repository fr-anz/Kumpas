...
const ShapeGrid = ({
  ...
  useEffect(() => {
    ...
    // Battery optimization: draw a single static frame and skip the animation
    // loop and hover handlers entirely — no continuous requestAnimationFrame.
    if (frozen) {
      drawGrid();
      return () => {
  ...
  }, [direction, speed, borderColor, hoverFillColor, squareSize, shape, hoverTrailAmount, frozen]);
