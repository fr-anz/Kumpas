  ...
  return (
    <section className="flex flex-1 flex-col gap-8">
      ...
      <div className="flex flex-col gap-3">
        ...
        <div
          className="grid grid-cols-2 gap-1 rounded-pill border border-border-lining bg-surface p-1 shadow-[2px_2px_0px_0px_var(--shadow-color)]"
          role="group"
            ...
            <button
              ...
              className={`min-h-12 rounded-pill px-4 text-base font-bold transition-all ${
                language === lng
                  ...
                  : "text-text hover:bg-surface-alt border border-transparent"
              }`}
            >
        ...
        <div className="grid grid-cols-3 gap-2">
          {sizes.map((s) => (
            <button
              ...
              className={`flex min-h-20 flex-col items-center justify-center gap-1 rounded-card border p-2 transition-all active:translate-x-[2px] active:translate-y-[2px] active:shadow-[2px_2px_0px_0px_var(--shadow-color)] ${
                fontSize === s.value
                  ? "border-border-lining bg-bee-yellow shadow-[2px_2px_0px_0px_var(--shadow-color)]"
                  : "border-border-lining bg-surface shadow-[2px_2px_0px_0px_var(--shadow-color)]"
              }`}
            >
              <span
                aria-hidden="true"
      ...
      >
        ...
        <div className="mt-2 flex flex-col gap-3">
          ...
          <button
            ...
            className="flex min-h-12 w-full items-center justify-center rounded-button border border-bee-black bg-surface px-6 text-base font-bold transition-all shadow-[2px_2px_0px_0px_var(--shadow-color)] hover:bg-surface-alt active:translate-x-[2px] active:translate-y-[2px] active:shadow-[2px_2px_0px_0px_var(--shadow-color)]"
          >
            {t("onb.setupLater")}
          </button>
        </div>
